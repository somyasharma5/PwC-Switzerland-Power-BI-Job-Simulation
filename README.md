...
- Overall answered and resolved calls
- Average handle time (talk duration)
- Call answered by Agents
- Call resolved by Agents
...
- Customers in the telecom industry are hard-earned: we don’t want to lose them. The retention department is here to get customers back in case of termination.
